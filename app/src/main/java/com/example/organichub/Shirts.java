...
public class Shirts extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        root.child("Male").child("Topwear").child("Shirts").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        root.child("Female").child("Topwear").child("Shirts").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
